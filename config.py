...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "postgres://myiovwbi:69ynpXf2cNuDlYj8CUxBJcMCYzTsAsY5@peanut.db.elephantsql.com/myiovwbi")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1337528464 1389078939 1245135578 5778100071").split()):
        ADMINS.append(int(x))
except ValueError:
